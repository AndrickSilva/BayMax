<%-- 
    Document   : search1
    Created on : 27 Jun, 2022, 7:36:17 PM
    Author     : joy20
--%>
...
PreparedStatement statment = conn.prepareStatement("select Link from new_table where demail = ?");
statment.setString(1, Demail);
...
out.println(e);
    ...
    <section>
        ...
        <div class="MeetCont">
            <button class="btn "><a href="DoctorInactive.jsp">Inactive</a></button>
            <button class="btn "><a href="DoctorActive.jsp">Active</a></button>
            <button class="btn "><a href="<%= Link %>" target="_blank">Open Meet Link</a></button>
        </div>
    </section>
</body>
</html>
